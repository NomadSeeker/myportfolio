    ...
    return (
        ...
        <section className='bg-gradient-to-r from-cyan-300 from-55% to-blue-400 py-6'>
            <div className='"py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12"'>
                ...
                <p className='mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48'>I'm a software engineer skilled in React, CSS, Node & Express</p>
            </div>
        ...
        <section className='bg-slate-100 py-7'>
            <div className='container mx-auto '>
                    ...
                    <div className='grid grid-cols-1 gap-5 justify-items-center md:grid-cols-3 md:gap-3 md:justify-items-stretch'>
                        <Card title="Natours Site" description="Web app for a tours business company." image="/myportfolio/images/Natours-site.png" buttonText="Visit Project" url="https://nattours24.netlify.app" />
                        <Card title="Nexter Site" description="Web app for a Real State business company." image="/myportfolio/images/Nexter-site.png" buttonText="Visit Project" url="https://next3r.netlify.app"/>
                        <Card title="Trillo Site" description="Web app for Travel Booking business." image="/myportfolio/images/Trillo-site.png" buttonText="Visit Project" url="https://tryllo.netlify.app"/>
